...
export const barChartDataTotalAccessTest = {
...
export const barChartDataTotalCourses2deTest = {
...
export const barChartMultipleTotalCoursesMissedAndTaught = {
  // labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
  labels: ["SBA", "SCI", "SCIAD", "SOSS", "SLAW", "SCOS", "SEDU"],
  dataUnit: "lectures",
  datasets: [
