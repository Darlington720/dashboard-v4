      ...
      <div className="card-inner">
        <div className="card-title-group align-start mb-3">
          <CardTitle className="card-title">
            <h6 className="title">E-learning Vs Physical Lectures</h6>
            <p>
        ...
        <div className="user-activity-group g-4">
          <div className="user-activity">
            ...
            <div className="info">
              <span className="amount">
                {" "}
                {userActivity === "day" ? "345" : userActivity === "month" ? "210" : "50"}
              </span>
          ...
          <div className="user-activity">
            <Icon name="users"></Icon>
            <div className="info">
              <span className="amount"> {userActivity === "day" ? "49" : userActivity === "month" ? "112" : "10"}</span>
